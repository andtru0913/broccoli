      ...
      <div className="">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex justify-center">
            <div
              className={
                "flex   justify-center  md:justify-start flex-col pb-20  px-3 md:pl-6 mt-4 "
              }
            >
              <div className=" pt-2 pl-4 flex justify-center md:justify-start">
          ...
          <div className={`${popHide} window-pop`} id={"modifyNotif"}>
            <div className="flex flex-col md:flex-row">
              <div className="realtive flex-col bg-secondary-1">
                ...
                <div className="flex flex-col ">
                  <form
                    className={"relative flex flex-col   p-2 md:pl-12 z-20"}
                  ...
                  >
                    <input
                      ...
                      value={"../../intranet/admin/notifications"}
                    />
                    <div className="flex flex-row md:pl-12 justify-center md:justify-start">
                      <div className={"flex flex-col  m-2"}>
                        <input
                          type={"hidden"}
                          name={"notifId"}
