const Card = ({ title, image, text, click }) => {
  return !image ? (
    ...
    <a
      onClick={click}
      className="relative md:mx-0 mb-4 md:mb-0 text-left bg-secondary-1 text-muted transition-all  hover:text-muted "
    >
      {/*  <div className="h-1/2 overflow-hidden">
        <img className=" w-full  bg-cover bg-center " src={image} />
      </div>*/}

      <div className="duration-150 ease-in-out hover:scale-105 flex flex-col items-left  p-14 md:p-12 lg:p-14  ">
