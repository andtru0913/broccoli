  ...
  return (
    <>
      <div onClick={handleSetIndex} className="">
        {index !== id ? (
          <div className="flex flex-1 group place-self-center flex-col p-2  cursor-pointer w-full border-transparent border-2  hover:border-black hover:border-2 hover:border-dashed rounded-lg">
            ...
            <div className=" flex flex-col pt-2 pl-2 md:w-56 w-36">
              <h5 className="select-none uppercase font-bold text-base ">
                {author}
              </h5>
            </div>
          </div>
        ) : (
          <div className="flex flex-1 group p-2 flex-col w-full  bg-secondary-d1/90 border-2 border-black border-dashed rounded-lg">
            ...
            <div className="flex flex-col p-2 md:w-56 md:h-64 mb-2 w-36 h-40 overflow-y-scroll">
              <div className="grid grid-cols-2  ">
                ...
                <h4 className="select-none text-xs">
                  <a
                    onClick={(e) => {
                      e.stopPropagation();
                    }}
